...
function useVuelidate(validations, state) {
  ...
  const instance = currentVueInstance || vueDemi.getCurrentInstance();
  const componentOptions = instance ? vueDemi.isVue3 ? instance.type : instance.proxy.$options : {}; // if there is no registration name, add one.
