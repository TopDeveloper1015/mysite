...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
 ...
 <div class="row">
  ...
  <div class="col-4"><Rightlisthome/></div>
</div>
...
import Rightlisthome from "../components/rightside/rightlisthome.vue";
...
checkWord(){
 ...
 async getShortArticles() {
      let result = await axios.get(
        "https://my-app-2-vfjnn.ondigitalocean.app/api/shortarticles"
      );
